const app = {
  ...
  showThings: function () {
    ...
    content.appendChild(app.cardBuilder(app.DATA.heroes));
  ...
  cardBuilder: function (arr) {
    ...
    arr.forEach((hero) => {
      ...
      img.src = hero.imgURL;
      img.className = "icon";
      img.alt = "Portrait of " + hero.Name;
      let title = document.createElement("h2");
      title.className = "item-title";
      title.setAttribute("data-key", hero.ID)
  ...
  getItem: function (id) {
    ...
    return app.DATA.heroes[parseInt(id)-1];
  },
  showDetails: function (obj) {
    ...
    caption.textContent = "Stats Information"
